...
// that flows into ICommandHandler<TCommand, TResponse>, allowing the handler to
// enforce a return type without the marker interface needing to declare it.
[SuppressMessage("Major Code Smell", "S2326:Unused type parameters should be removed",
    Justification = "TResponse is a phantom type parameter used by ICommandHandler<TCommand,TResponse> to enforce return type contracts.")]
